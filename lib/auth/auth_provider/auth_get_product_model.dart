...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
        ...
        brandListing: List<BrandListing>.from(
            json["brand_listing"].map((x) => BrandListing.fromJson(x))),
        topSellingProducts: List<Category>.from(
            json["top_selling_products"].map((x) => Category.fromJson(x))),
        featuredLaptop: List<BrandListing>.from(
            json["featured_laptop"].map((x) => BrandListing.fromJson(x))),
        upcomingLaptops: List<TopBrand>.from(
            json["upcoming_laptops"].map((x) => TopBrand.fromJson(x))),
        unboxedDeals: List<BrandListing>.from(
            json["unboxed_deals"].map((x) => BrandListing.fromJson(x))),
        myBrowsingHistory: List<BrandListing>.from(
            json["my_browsing_history"].map((x) => BrandListing.fromJson(x))),
      );
